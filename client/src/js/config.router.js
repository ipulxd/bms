  ...
  ['$rootScope', '$state', '$stateParams', 'AuthService',
    function ($rootScope, $state, $stateParams, AuthService) {
      ...
      $rootScope.$on('$stateChangeStart', function (e, toState, toParams, fromState, fromParams) {
        ...
        var toLogin = toState.name === 'access.login';
    ...
    function ($stateProvider, $urlRouterProvider, JQ_CONFIG) {
      ...
      $stateProvider
            ...
            deps: ['$ocLazyLoad',
              function ($ocLazyLoad) {
                return $ocLazyLoad.load(['smart-table', 'toaster', 'ui.select']).then(
                  function () {
                    return $ocLazyLoad.load(['js/controllers/person.js', JQ_CONFIG.moment]);
                  }
                )
              }]
          }
        ...
        .state('app.person.list', {
          url: '/list',
          templateUrl: 'tpl/person/index.html'
        })
        .state('app.person.new', {
          url: '/new',
          templateUrl: 'tpl/person/new.html'
        })
        .state('app.person.edit', {
          url: '/:id/edit',
          templateUrl: 'tpl/person/edit.html'
        })
        .state('app.person.detail', {
          url: '/:id/detail',
          templateUrl: 'tpl/person/detail.html'
        })
        ...
        .state('setting', {
          ...
          resolve: {
            deps: ['$ocLazyLoad',
              function ($ocLazyLoad) {
                return $ocLazyLoad.load(['smart-table', 'toaster', 'ui.select']);
              }]
          }
        })
        .state('setting.property', {
          ...
          resolve: {
            deps: ['$ocLazyLoad', function ($ocLazyLoad) {
              return $ocLazyLoad.load('js/controllers/config-property.js');
            }]
          }
        })
        .state('setting.property.set-scope', {
          url: '/set-scope',
        ...
        .state('setting.building', {
          url: '/building',
          template: '<div ui-view></div>',
          resolve: {
            deps: ['$ocLazyLoad', function ($ocLazyLoad) {
              return $ocLazyLoad.load('js/controllers/config-building.js');
            }]
          }
        })
        .state('setting.building.list', {
          url: '/list',
          templateUrl: 'tpl/building/index.html'
        })
        .state('setting.building.new', {
          url: '/new',
          templateUrl: 'tpl/building/new.html'
        })
        ...
        .state('setting.user.edit', {
          url: '/:id/edit',
          templateUrl: 'tpl/user/edit.html'
        })
        .state('setting.user.passwd', {
          url: '/:id/passwd',
        ...
        .state('access.login', {
          url: '/login',
          templateUrl: 'tpl/access_login.html',
          resolve: {
            deps: ['uiLoad',
              function (uiLoad) {
